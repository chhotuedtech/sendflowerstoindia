...
class Sm_Milan_Model_Observer {

	public function less_compile( $observer ){	
	
		$setting = Mage::helper('milan/data');
		$less_theme_compile     = Mage::getStoreConfig('milan_cfg/advanced/less_compile');
		$preset_name 			= Mage::getStoreConfig('milan_cfg/general/color');
		$device_responsive      = Mage::getStoreConfig('milan_cfg/general/device_responsive'); 
		$direction      		= Mage::getStoreConfig('milan_cfg/general/direction');
