    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn('method', array(
            ...
            'index' => 'method',
			'type'      =>'options',
		  	'options'   => Mage::getSingleton('supplier/source_types')->toOptionArray()
        ));
		...
		$this->addColumn('status', array(
            ...
            'index' => 'status',
			'type'      =>'options',
		  	'options'   => Mage::getSingleton('supplier/source_dropship')->toOptionArray()
        ));
	...
	public function getGridUrl()
    {
		...
		return $this->getUrl('supplier/adminhtml_web/dropshipments',array('id' => $this->getRequest()->getParam('id')));
    }
