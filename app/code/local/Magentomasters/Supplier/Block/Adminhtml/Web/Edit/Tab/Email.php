...
class Magentomasters_Supplier_Block_Adminhtml_Web_Edit_Tab_Email extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
 	...
 	$fieldset->addField('email_subject', 'text', array(
          'label'     => Mage::helper('supplier')->__('Email Subject'),
          'name'      => 'email_subject',
	...
	$fieldset->addField('email_attachement', 'select', array(
        'label'     => Mage::helper('supplier')->__('Attachement'),
        'name'      => 'email_attachement',
        'values'    => array(
                array(
                        'value'     => 0,
                        'label'     => Mage::helper('supplier')->__('Disabled'),
        ...
        'note'	  => "Make sure to enable choosen output in XML/CSV tab" 
  	));	
