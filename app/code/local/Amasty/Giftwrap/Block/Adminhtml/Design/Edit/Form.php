 ...
 * @author Amasty
 */
class Amasty_Giftwrap_Block_Adminhtml_Design_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        $model = Mage::registry('amgiftwrap_design');
        ...
        $fldInfo = $form->addFieldset('amgiftwrap_info', array('legend' => $hlp->__('Design info')));
    ...
    protected function getImageHtml($img)
    {
        ...
        if ($img) {
            ...
            $html .= '<img src="' . Mage::helper('amgiftwrap')->getImageThumbnail($img, 'design') . '" />';
